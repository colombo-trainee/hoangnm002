(function (k, f, c, j, d, l, g) {/*! Jssor */
    ...
    var b = new function () {
        ...
        function Jb() {
            if (!M) {
                ...
                var a;
                if (D.pointerEnabled || (a = D.msPointerEnabled))M.nd = a ? "msTouchAction" : "touchAction"
            }
            return M
        }
        ...
        h.$Delay = yb;
        function bb(a) {
            a.constructor === bb.caller && a.Md && a.Md.apply(a, bb.caller.arguments)
        }
        ...
        h.Zf = function (d, a) {
            if (a)d.style.clip = "rect(" + c.round(a.$Top || a.I || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.J || 0) + "px)"; else if (a !== g) {
        ...
        var X = {$Opacity: h.yb, $Top: h.z, $Left: h.A, R: h.k, Q: h.m, Db: h.B, Ih: h.T, $ZIndex: h.E};
        ...
        function w(f, l) {
            ...
            w = function (e, c) {
                ...
                if (c.Re)if (d)yb(h.F(j, P, e, c)); else a(e, c)
            };
            h.Eb = P;
            if (d)h.Eb = w;
            if (e)h.Eb = a; else if (!b)a = P;
            h.K = w;
            w(f, l)
        }
        ...
        h.fc = function (a) {
            var c = a || {};
            if (a)if (b.Wc(a))c = {hc: c}; else if (b.Wc(a.$Clip))c.$Clip = {hc: a.$Clip};
            return c
        };
        function wb(c, a) {
            var b = {};
            n(c, function (c, d) {
                var e = c;
                if (a[d] != g)if (h.Hb(c))e = c + a[d]; else e = wb(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        h.Tc = function (l, m, w, n, y, z, o) {
            ...
            if (l) {
                a = {};
                for (var h in m) {
                    var A = z[h] || 1, v = y[h] || [0, 1], f = (w - v[0]) / v[1];
                    f = c.min(c.max(f, 0), 1);
                    f = f * A;
                    var u = c.floor(f);
                    if (f != u)f -= u;
                    var i = n.hc || e.$EaseSwing, k, B = l[h], q = m[h];
                    if (b.Hb(q)) {
                        i = n[h] || i;
                        var x = i(f);
                        k = B + q * x
                        ...
                        k = b.r({Jb: {}}, l[h]);
                        b.a(q.Jb || q, function (d, a) {
                            if (n.$Clip)i = n.$Clip[a] || n.$Clip.hc || i;
                            var c = i(f), b = d * c;
                            k.Jb[a] = b;
                            k[a] += b
                        })
            ...
            if (m.$Clip && o.$Move) {
                var p = a.$Clip.Jb, s = (p.$Top || 0) + (p.$Bottom || 0), r = (p.$Left || 0) + (p.$Right || 0);
                a.$Left = (a.$Left || 0) + r;
                a.$Top = (a.$Top || 0) + s;
                a.$Clip.$Left -= r;
                a.$Clip.$Right -= r;
    ...
    var p = k.$JssorSlideshowFormations$ = new function () {
        ...
        h.$FormationStraight = function (f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.Ib, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)for (a = 0; a < d; a++) {
                switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
                        break;
    ...
    k.$JssorSlideshowRunner$ = function (k, s, q, u, z) {
        ...
        function i(g, f) {
            ...
            a.Od = function (c, b) {
                ...
                if (!a.Kb[f]) {
                    a.Kb[f] = {R: c, Q: b};
                    for (var d = 0; d < a.$Cols; d++)for (var e = 0; e < a.$Rows; e++)a.Kb[f][e + "," + d] = {
                        $Top: e * b,
                        $Right: d * c + c,
                        $Bottom: e * b + b,
                        $Left: d * c
        ...
        function o(B, h, a, w, o, m) {
            ...
            z.dc = function (d) {
                ...
                if (e || y) {
                    ...
                    b.a(i, function (a, e) {
                        ...
                        if (a.ud != d) {
                            if (!a.ud && !k)b.v(n[e]); else d == a.ee && k && b.S(n[e]);
                            a.ud = d;
                            b.K(n[e], a[d])
                        }
                    })
            ...
            b.a(p, function (h, j) {
                b.a(h, function (G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        var H = d;
                        if (b.fb())if (a.$Cols * a.$Rows > 1)H = l; else I = l;
                        if (H) {
                    ...
                    if (I) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (C && z) {
                                h.$Top = g.Q / 2 * w;
                                h.$Bottom = -h.$Top
                            } else if (C)h.$Bottom = -g.Q * w; else if (z)h.$Top = g.Q * w;
                            if (B && A) {
                                h.$Left = g.R / 2 * w;
                                h.$Right = -h.$Left
    ...
    var i = k.$JssorSlider$ = function (p, hc) {
        ...
        function Bc(k, f) {
            ...
            function ab(b) {
                if (b == R && s == f) {
                    if (!g) {
                        var a = j;
                        if (A)if (A.ob == f)a = A.Je(); else A.tb();
                        Y();
                        g = new zc(k, f, a, q);
                        g.Fd(p)
                    }
            ...
            function S(d, h, l) {
                if (d == f) {
                    if (d != h)C[h] && C[h].De(); else!l && g && g.Ke();
                    p && p.$Enable();
                    var m = R = b.M();
                    e.xb(b.F(j, ab, m))
                } else {
            ...
            function T(a, c, e) {
                ...
                b.a(f, function (f) {
                    ...
                    if (i == "caption") {
                        ...
                        if (h == "A") {
                            if (b.j(f, "u") == "image")o = b.Jg(f, "IMG"); else o = b.C(f, "image", d);
                            if (o) {
                                w = f;
                                b.T(w, "block");
                                b.K(w, V);
        ...
        function zc(y, f, p, q) {
            ...
            a.tc = function () {
                ...
                if (!B && !O && !r && s == f) {
                    ...
                    if (b != c)if (b == e)l = c; else if (b == j)l = e; else if (!b)l = j; else l = a.Hd();
                    h.l(p, f, b, n, j, e, c);
                    var m = P && (!E || F);
                    if (b == c)(e != c && !(E & 12) || m) && o.Sd(); else(m || b != e) && a.Lc(l, w)
                }
            };
            a.Ke = function () {
                e == c && e == a.qb() && a.D(j)
        ...
        var gb = a.$PlayOrientation & 3, xc = (a.$PlayOrientation & 4) / -4 || 1, db = a.$SlideshowOptions, I = b.r({
            $Class: q,
            $PlayInMode: 1,
            $PlayOutMode: 1,
            $HWA: a.$HWA
        ...
        b.a(yc, function (a) {
            if (a.tagName == "DIV" && !b.j(a, "u"))T.push(a); else b.fb() && b.E(a, (b.E(a) || 0) + 1)
        });
        ...
        if (r) {
            ...
            Gb(X());
            b.e(v, "click", mc, d);
            b.e(p, "mouseout", b.Sb(kc, p));
            b.e(p, "mouseover", b.Sb(jc, p));
            zb();
        ...
        f.wc = function (E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    b.H(e, l);
                    B[f] = l;
                    a.$ActionMode & 1 && b.e(l, "click", b.F(j, t, f));
                    a.$ActionMode & 2 && b.e(l, "mouseover", b.Sb(b.F(j, t, f), l));
                    y[f] = b.Tb(l)
                }
                u = d
            }
        };
        f.Nb = a = b.r({$SpacingX: 20, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, C);
        g = b.C(e, "prototype");
        q = b.k(g);
        p = b.m(g);
        b.zb(g, e);
    ...
    k.$JssorArrowNavigator$ = function (a, g, h) {
        ...
        c.wc = function (c) {
            ...
            e = 0;
            if (!m) {
                b.e(a, "click", b.F(j, k, -i));
                b.e(g, "click", b.F(j, k, i));
                b.Tb(a);
                b.Tb(g);
                m = d
            }
        };
        c.Nb = f = b.r({$Steps: 1}, h);
        i = f.$Steps;
        if (f.$Scale == l) {
            b.u(a, "noscale", d);
            b.u(g, "noscale", d)
    ...
    k.$JssorThumbnailNavigator$ = function (g, B) {
        ...
        function A(n, f) {
            ...
            m = b.Tb(c);
            a.$ActionMode & 1 && b.e(c, "click", b.F(j, i, 0));
            a.$ActionMode & 2 && b.e(c, "mouseover", b.Sb(b.F(j, i, 1), c))
        }
        ...
        h.Nb = a = b.r({$SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1}, B);
        z = b.k(g);
        x = b.m(g);
        f = b.C(g, "slides", d);
        k = b.C(f, "prototype");
    ...
    k.$JssorCaptionSlideo$ = function (n, f, l) {
        ...
        function j(d, c) {
            ...
            b.a(d, function (d, f) {
                var e = g[f];
                if (e) {
                    if (b.Yc(d))d = j(d, c || f == "e"); else if (c)if (b.Hb(d))d = o[d];
                    a[e] = d
                }
            });
            return a
        ...
        function r(d, e, a) {
            b.a(e, function (g) {
                ...
                var h = {$Easing: f, $OriginalWidth: a.R, $OriginalHeight: a.Q}, i = new m(g.b, g.d, h, d, a, e);
                c.wb(i);
                a = b.ze(a, e)
            });
            return a
        ...
        o = [h.$Swing, h.$Linear, h.$InQuad, h.$OutQuad, h.$InOutQuad, h.$InCubic, h.$OutCubic, h.$InOutCubic, h.$InQuart, h.$OutQuart, h.$InOutQuart, h.$InQuint, h.$OutQuint, h.$InOutQuint, h.$InSine, h.$OutSine, h.$InOutSine, h.$InExr, h.$OutExpo, h.$InOutExpo, h.$InCirc, h.$OutCirc, h.$InOutCirc, h.$InElastic, h.$OutElastic, h.$InOutElastic, h.$InBack, h.$OutBack, h.$InOutBack, h.$InBounce, h.$OutBounce, h.$InOutBounce, h.$GoBack, h.$InWave, h.$OutWave, h.$OutJump, h.$InJump];
        var u = {
            $Top: "y",
            $Left: "x",
            $Bottom: "m",
